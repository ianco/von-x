...
def get_standard_routes(_app) -> list:
    ...
    return [
        ...
        web.get('/{connection_id}/search-credential/{org_name}', views.search_credential),
        web.get('/{connection_id}/search-credential/{org_name}/{proof_name}', views.filter_credential),
        web.get('/{connection_id}/render-credential', views.render_credential),
